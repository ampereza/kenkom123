...
def create_app():
    ...
    from main_folder import accounting, dashboard, stock, treatment, auth, reports, smtp, teset, inventory, daily_reports  # <== your modules
    ...
    app.register_blueprint(daily_reports.daily_reports)
